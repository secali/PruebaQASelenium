...
public class INNOcvSteps {
    ...
    public static  void main(String [] args){
        ...
        if(text.contains(telf)) System.out.println("Contiene el numero de telf");
        ...
        System.out.println(StringUtils.countMatches(texto_contacto, "Faraday"));
        ...
        if(inno.getAlertaFormulario()=="") System.out.println("La alerta no ha aparecido");
